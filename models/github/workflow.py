...
#   timestamp: 2025-06-25T22:12:47+00:00
...
class Outputs(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description='A string description of the output parameter.'
    )
    value: str = Field(
        ...,
...
class Secrets(BaseModel):
    ...
    required: Optional[bool] = Field(
        None, description='A boolean specifying whether the secret must be supplied.'
    )
...
class WorkflowCall(BaseModel):
    ...
    outputs: Optional[Dict[constr(pattern=r'^[_a-zA-Z][a-zA-Z0-9_-]*$'), Outputs]] = (
        Field(
            None,
            description='When using the workflow_call keyword, you can optionally specify inputs that are passed to the called workflow from the caller workflow.',
        )
    )
    secrets: Optional[Dict[constr(pattern=r'^[_a-zA-Z][a-zA-Z0-9_-]*$'), Secrets]] = (
        Field(
            None,
...
class EventObject(RootModel[Optional[Dict[str, Any]]]):
...
class Glob(RootModel[constr(min_length=1)]):
    root: constr(min_length=1)


class Globs(RootModel[List[Glob]]):
    root: List[Glob] = Field(..., min_length=1)
...
class Name(RootModel[constr(pattern=r'^[_a-zA-Z][a-zA-Z0-9_-]*$')]):
    root: constr(pattern=r'^[_a-zA-Z][a-zA-Z0-9_-]*$')


class Path(RootModel[Globs]):
    root: Globs = Field(
        ...,
...
class Shell(RootModel[Union[str, Shell1]]):
    root: Union[str, Shell1] = Field(
        ...,
...
class Types(RootModel[Union[List, str]]):
    root: Union[List, str] = Field(
        ...,
...
class WorkingDirectory(RootModel[str]):
    root: str = Field(
        ...,
...
class JobNeeds(RootModel[Union[List[Name], Name]]):
    root: Union[List[Name], Name] = Field(
        ...,
...
class Matrix(
    RootModel[
        Union[
            Dict[
                constr(pattern=r'^(in|ex)clude$'),
                Union[ExpressionSyntax, List[Dict[str, Configuration]]],
            ],
            ExpressionSyntax,
        ]
    ]
...
class WorkflowDispatch(BaseModel):
    ...
    inputs: Optional[
        Dict[constr(pattern=r'^[_a-zA-Z][a-zA-Z0-9_-]*$'), WorkflowDispatchInput]
    ] = Field(
        None,
...
class PermissionsEvent(BaseModel):
    ...
    attestations: Optional[PermissionsLevel] = None
...
class Env(
    ...
    root: Union[
        Dict[str, Union[str, float, bool]], StringContainingExpressionSyntax
    ] = Field(
        ...,
...
class Step1(BaseModel):
    ...
    if_: Optional[Union[bool, float, str]] = Field(
        None,
        alias='if',
    ...
    timeout_minutes: Optional[Union[float, ExpressionSyntax]] = Field(
        None,
...
class Step(RootModel[Union[Step1, Step2]]):
    root: Union[Step1, Step2]
...
class On(BaseModel):
    ...
    merge_group: Optional[EventObject] = Field(
        None,
...
class Permissions(RootModel[Union[Permissions1, PermissionsEvent]]):
    root: Union[Permissions1, PermissionsEvent] = Field(
        ...,
...
class ReusableWorkflowCallJob(BaseModel):
    ...
    uses: constr(pattern=r'^(.+\/)+(.+)\.(ya?ml)(@.+)?$') = Field(
        ...,
    ...
    secrets: Optional[Union[Env, Secrets1]] = Field(
        None,
...
class Workflow(BaseModel):
    ...
    on: Union[Event, List[Event], On] = Field(
        ...,
